...
<head>
    ...
    <title>Gerai Listrik Dimas</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
    <script type="text/javascript">
    window.$crisp = [];
    window.CRISP_WEBSITE_ID = "46cb0d0b-f027-4140-89cc-56dc72915749";
    (function() {
        d = document;
...
<body>
            ...
            <div class="container px-0">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- <ul class="navbar-nav me-auto navigation">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="#">Panduan Pemasangan</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ms-auto authentication">
                        <li class="nav-item my-auto text-center login">
                            <a class="nav-link cl-white mb-3 mb-md-0" aria-current="page" href="#panduan">Panduan
                                Pemasangan</a>
                        </li>
                        <!-- <li class="nav-item me-0 text-center">
                            <a class="nav-link signup" href="#">
                                Registrasi <span class="ms-2"><img
        ...
        <div class="container header position-relative">
            <div class="row">
                <div class="col-lg-6 px-md-0 my-auto">
                    <div class="headline">
                        Website Pemasangan Listrik Baru Pada <span class="cl-light-blue">Gerai Dimas</span>
                    </div>
                    ...
                    <div class="row four-point">
                        <div class="col-md-6">
                            <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/dark/Vector.png"
                                alt="vector" class="me-3"> Mudah
                        </div>
                        <div class="col-md-6">
                            <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/dark/Vector.png"
                                alt="vector" class="me-3"> Terpercaya
                        </div>
                        <div class="col-md-6">
                            <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/dark/Vector.png"
                                alt="vector" class="me-3"> Cepat
                        </div>
                        <!-- <div class="col-md-6">
                            <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/dark/Vector.png"
    ...
    <section id="panduan" class="h-100 w-100" style="box-sizing: border-box; background-color: #000000">
        <style>
        ...
        <div class="content-3-4 container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif;">
            <div class="d-flex flex-lg-row flex-column align-items-center">
                ...
                <div
                    ...
                    <h2 class="title-text text-white">Panduan Pemasangan</h2>
                    <ul style="padding:0;margin:0">
                        <li class="list-unstyled" style="margin-bottom: 2rem;">
                            <h4
                                ...
                                Silakan hubungi kami melalui live chat
                            </h4>
                            <!-- <p class="text-caption">
                                Registrasi akun anda terlebih dahulu<br class=" d-sm-inline d-none">
                                for several years.
                            </p> -->
                        </li>
                        <!-- <li class="list-unstyled" style="margin-bottom: 2rem;">
        ...
        <div class="container-fluid text-md-left">
            <div class="row">
                <div class="col-md-5 mt-md-0 mt-3">
                    <h3 class="font-weight-bold mb-4">House</h3>
                    <p class="mb-2">
                        Dago, Bandung
                    </p>
                    <p>
